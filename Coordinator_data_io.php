    ...
    if (isset($_POST['import_students'])) {
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    title: 'Success!',
                    text: 'Student list imported successfully! (Simulation)',
                    icon: 'success',
...
<head>
    ...
    <title>Data Management - Coordinator</title>
    ...
    <div class="main-content-wrapper">
        <div class="page-header">
            <div class="welcome-text">
                ...
                <p>Import new records or export system data.</p>
            </div>
        ...
        <div class="io-grid">
            <div class="io-card">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="file-drop">
                        <input type="file" name="student_file" accept=".csv, .xlsx" style="color: var(--text-color);">
                    </div>
