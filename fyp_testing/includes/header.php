...
// Menu items
$menu_items = [
    'dashboard' => ['name' => 'Dashboard', 'icon' => 'fa-home', 'file' => 'Coordinator_dashboard.php'],
    ...
    'rubrics' => ['name' => 'Rubrics Assessment', 'icon' => 'fa-list-check', 'file' => 'Coordinator_rubrics.php'],
    'marks' => ['name' => 'Assessment Marks', 'icon' => 'fa-calculator', 'file' => 'Coordinator_marks.php'],
    'report' => ['name' => 'Reports', 'icon' => 'fa-file-alt', 'file' => 'Coordinator_report.php'],
    'announcement' => ['name' => 'Announcements', 'icon' => 'fa-bullhorn', 'file' => 'Coordinator_announcement.php'],
    'settings' => ['name' => 'Settings', 'icon' => 'fa-cog', 'file' => 'Coordinator_settings.php'],
];

// Get current page title
$page_title = 'Dashboard';
foreach ($menu_items as $key => $item) {
    if (strpos($current_page, $key) !== false) {
