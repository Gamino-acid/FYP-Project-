...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['ajax_post'])) {
    ...
    $sql_insert = "INSERT INTO announcement (fyp_subject, fyp_description, fyp_receiver, fyp_datecreated, fyp_staffid, fyp_status) VALUES (?, ?, ?, ?, ?, 'Active')";
...
<head>
    ...
    <style>
        ...
        .specific-target-container { display: none; margin-top: 10px; padding: 15px; background: var(--slot-bg); border-radius: 6px; border: 1px dashed var(--border-color); }
            ...
            <form id="postForm" onsubmit="submitForm(event)">
                ...
                <div class="form-group">
                    ...
                    <div id="specific_target_container" class="specific-target-container">
                        <label for="specific_target" style="font-size:13px; color:var(--text-secondary);">Select Project / Team:</label>
